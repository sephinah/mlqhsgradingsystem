...
public function g7_sec1()
	{
			...
			$crud->columns('LRN','lastName','firstName','extension','ExtensionName','empNumber','GradeLevel','Section','SchoolYear','Sex','Birthdate','MAPEH1','MAPEH2','MAPEH3','MAPEH4','MAPEHAVE');
			

			$crud->set_table('187section1');
