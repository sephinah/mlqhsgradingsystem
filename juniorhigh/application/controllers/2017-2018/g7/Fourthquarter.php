...
class Fourthquarter extends CI_Controller {
...
public function _fourthquarter_output($output = null)
	{
		$this->load->view('fourthquarter.php',(array)$output);
	}

	public function index()
	{
		$this->_fourthquarter_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL4','ENG4','MATH4','SCI4','AP4','ESP4','EPP4','MAPEH4','MU4','AR4','PE4','HE4');	
...
//FIRST GRADING VIEW TAB -- FOR ALL GRADES
				 ...
				 $crud->field_type('ENG1','hidden');$crud->field_type('FIL1','hidden');$crud->field_type('MATH1','hidden');$crud->field_type('SCI1','hidden');$crud->field_type('AP1','hidden');$crud->field_type('ESP1','hidden');$crud->field_type('EPP1','hidden');$crud->field_type('MAPEH1','hidden');$crud->field_type('MU1','hidden');$crud->field_type('AR1','hidden');$crud->field_type('PE1','hidden');$crud->field_type('HE1','hidden');$crud->field_type('BACK1','hidden');$crud->field_type('BACK1A','hidden');$crud->field_type('BACK1AA','hidden');
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->callback_before_update(array($this,'general_average7s1'));
			  ...
			  $output = $crud->render();
			$this->_fourthquarter_output($output);
	}
...
//COMMENT HERE TO UNLOCK 2ND QTR
			$crud->field_type('ENG2','hidden');$crud->field_type('FIL2','hidden');$crud->field_type('MATH2','hidden');$crud->field_type('SCI2','hidden');$crud->field_type('AP2','hidden');$crud->field_type('ESP2','hidden');$crud->field_type('EPP2','hidden');$crud->field_type('MAPEH3','hidden');$crud->field_type('MU2','hidden');$crud->field_type('AR2','hidden');$crud->field_type('PE2','hidden');$crud->field_type('HE2','hidden');$crud->field_type('BACK2','hidden');$crud->field_type('BACK2A','hidden');$crud->field_type('BACK2AA','hidden');
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
	...
	function general_average725($post_array) {
