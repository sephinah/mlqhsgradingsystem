...
class Secondquarter extends CI_Controller {
...
public function _secondquarter_output($output = null)
	{
		$this->load->view('secondquarter.php',(array)$output);
	}

	public function index()
	{
		$this->_secondquarter_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL2','ENG2','MATH2','SCI2','AP2','ESP2','EPP2','MAPEH2','MU2','AR2','PE2','HE2');	
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->callback_before_update(array($this,'general_average7s1'));
			  ...
			  $output = $crud->render();
			$this->_secondquarter_output($output);
	}
