...
class Thirdquarter extends CI_Controller {
...
public function _thirdquarter_output($output = null)
	{
		$this->load->view('thirdquarter.php',(array)$output);
	}

	public function index()
	{
		$this->_thirdquarter_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL3','ENG3','MATH3','SCI3','AP3','ESP3','EPP3','MAPEH3','MU3','AR3','PE3','HE3');	
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->callback_before_update(array($this,'general_average7s1'));
			  ...
			  $output = $crud->render();
			$this->_thirdquarter_output($output);
	}
