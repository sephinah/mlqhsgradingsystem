...
class Firstquarter extends CI_Controller {
...
public function _firstquarter_output($output = null)
	{
		$this->load->view('firstquarter.php',(array)$output);
	}

	public function index()
	{
		$this->_firstquarter_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL1');	
...
$crud->field_type('ENG1','hidden');$crud->field_type('MATH1','hidden');$crud->field_type('SCI1','hidden');$crud->field_type('AP1','hidden');$crud->field_type('ESP1','hidden');$crud->field_type('EPP1','hidden');$crud->field_type('MAPEH1','hidden');$crud->field_type('MU1','hidden');$crud->field_type('AR1','hidden');$crud->field_type('PE1','hidden');$crud->field_type('HE1','hidden');$crud->field_type('BACK1','hidden');$crud->field_type('BACK1A','hidden');$crud->field_type('BACK1AA','hidden');
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->callback_before_update(array($this,'general_average7s1'));
			  ...
			  $output = $crud->render();
			$this->_firstquarter_output($output);
	}
...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL1','ENG1','MATH1','SCI1','AP1','ESP1','EPP1','MAPEH1','MU1','AR1','PE1','HE1');	
...
//HIDE ALL SUBJECTS EXCEPT FILIPINO FIRST QUARTER GRADE

			$crud->field_type('ENG1','hidden');$crud->field_type('FIL2','hidden');$crud->field_type('MATH1','hidden');$crud->field_type('SCI1','hidden');$crud->field_type('AP1','hidden');$crud->field_type('ESP1','hidden');$crud->field_type('EPP1','hidden');$crud->field_type('MAPEH1','hidden');$crud->field_type('MU1','hidden');$crud->field_type('AR1','hidden');$crud->field_type('PE1','hidden');$crud->field_type('HE1','hidden');$crud->field_type('BACK1','hidden');$crud->field_type('BACK1A','hidden');$crud->field_type('BACK1AA','hidden');
