...
//$this->config->set_item('grocery_crud_default_per_page',50);
			...
			$crud->set_subject('Grade 7 Section 1');
			...
			$crud->columns('LRN','lastName','firstName','extension','Sex','FIL1','ENG1','MATH1','SCI1','AP1','ESP1','EPP1','MAPEH1','MU1','AR1','PE1','HE1','FinalAve');	
...
$post_array['FinalAve'] = ($post_array['FIL1'] + $post_array['ENG1'] + $post_array['MATH1'] + $post_array['SCI1'] + $post_array['AP1'] + $post_array['ESP1'] + $post_array['EPP1'] + $post_array['MAPEH1']) / 8;
