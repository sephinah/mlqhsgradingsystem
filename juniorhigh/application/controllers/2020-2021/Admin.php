...
public function encode()
	{
			...
			$crud->set_subject('Grades SY 2020-2021');
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->field_type('SY20202021ENGAVE','invisible');
			$crud->field_type('SY20202021FILAVE','invisible');
			$crud->field_type('SY20202021MATHAVE','invisible');
			$crud->field_type('SY20202021SCIAVE','invisible');
			$crud->field_type('SY20202021APAVE','invisible');
			$crud->field_type('SY20202021ESPAVE','invisible');
			$crud->field_type('SY20202021EPPAVE','invisible');
			$crud->field_type('SY20202021MUAVE','invisible');
			$crud->field_type('SY20202021MAPEHAVE','invisible');
			$crud->field_type('SY20202021ARAVE','invisible');
			$crud->field_type('SY20202021PEAVE','invisible');
			$crud->field_type('SY20202021HEAVE','invisible');
			$crud->field_type('SY20202021BACKAVE','invisible');
			$crud->field_type('SY20202021BACKAAVE','invisible');
			$crud->field_type('SY20202021BACKAAAVE','invisible');			
			$crud->field_type('SY20202021ENGAVE','invisible');
			$crud->field_type('SY20202021FILAVE','invisible');
			$crud->field_type('SY20202021MATHAVE','invisible');
			$crud->field_type('SY20202021SCIAVE','invisible');
			...
			$crud->field_type('SY2018-2019','invisible');
	...
	function general_average7s1($post_array) {
		...
		$post_array['SY20202021MAPEH1']= round(($post_array['SY20202021MU1'] + $post_array['SY20202021AR1'] + $post_array['SY20202021PE1'] + $post_array['SY20202021HE1']) / 4);
$post_array['SY20202021MAPEH2'] = round(($post_array['SY20202021MU2'] + $post_array['SY20202021AR2'] + $post_array['SY20202021PE2'] + $post_array['SY20202021HE2']) / 4);
$post_array['SY20202021MAPEH3'] = round(($post_array['SY20202021MU3'] + $post_array['SY20202021AR3'] + $post_array['SY20202021PE3'] + $post_array['SY20202021HE3']) / 4);
$post_array['SY20202021MAPEH4'] = round(($post_array['SY20202021MU4'] + $post_array['SY20202021AR4'] + $post_array['SY20202021PE4'] + $post_array['SY20202021HE4']) / 4);
$post_array['SY20202021MAPEHAVE'] = round(($post_array['SY20202021MAPEH1'] + $post_array['SY20202021MAPEH2'] + $post_array['SY20202021MAPEH3'] + $post_array['SY20202021MAPEH4']) / 4);

$post_array['SY20202021FILAVE'] = round(($post_array['SY20202021FIL1'] + $post_array['SY20202021FIL2'] + $post_array['SY20202021FIL3'] + $post_array['SY20202021FIL4']) / 4);
$post_array['SY20202021ENGAVE'] = round(($post_array['SY20202021ENG1'] + $post_array['SY20202021ENG2'] + $post_array['SY20202021ENG3'] + $post_array['SY20202021ENG4']) / 4);
$post_array['SY20202021MATHAVE'] = round(($post_array['SY20202021MATH1'] + $post_array['SY20202021MATH2'] + $post_array['SY20202021MATH3'] + $post_array['SY20202021MATH4'])/ 4);
$post_array['SY20202021SCIAVE'] = round(($post_array['SY20202021SCI1'] + $post_array['SY20202021SCI2'] + $post_array['SY20202021SCI3'] + $post_array['SY20202021SCI4']) / 4);
$post_array['SY20202021APAVE'] = round(($post_array['SY20202021AP1'] + $post_array['SY20202021AP2'] + $post_array['SY20202021AP3'] + $post_array['SY20202021AP4']) / 4);
$post_array['SY20202021ESPAVE'] = round(($post_array['SY20202021ESP1'] + $post_array['SY20202021ESP2'] + $post_array['SY20202021ESP3'] + $post_array['SY20202021ESP4']) / 4);
$post_array['SY20202021EPPAVE'] = round(($post_array['SY20202021EPP1'] + $post_array['SY20202021EPP2'] + $post_array['SY20202021EPP3'] + $post_array['SY20202021EPP4']) / 4);
$post_array['SY20202021MUAVE'] = ($post_array['SY20202021MU1'] + $post_array['SY20202021MU2'] + $post_array['SY20202021MU3'] + $post_array['SY20202021MU4']) / 4;
$post_array['SY20202021ARAVE'] = ($post_array['SY20202021AR1'] + $post_array['SY20202021AR2'] + $post_array['SY20202021AR3'] + $post_array['SY20202021AR4']) / 4;
$post_array['SY20202021PEAVE'] = ($post_array['SY20202021PE1'] + $post_array['SY20202021PE2'] + $post_array['SY20202021PE3'] + $post_array['SY20202021PE4']) / 4;
$post_array['SY20202021HEAVE'] = ($post_array['SY20202021HE1'] + $post_array['SY20202021HE2'] + $post_array['SY20202021HE3'] + $post_array['SY20202021HE4']) / 4;

$post_array['SY20202021FinalAve'] = ($post_array['SY20202021FILAVE'] + $post_array['SY20202021ENGAVE'] + $post_array['SY20202021MATHAVE'] + $post_array['SY20202021SCIAVE'] + $post_array['SY20202021APAVE'] + $post_array['SY20202021ESPAVE'] + $post_array['SY20202021EPPAVE'] + $post_array['SY20202021MAPEHAVE']) / 8;
