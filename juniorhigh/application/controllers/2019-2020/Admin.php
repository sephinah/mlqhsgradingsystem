...
public function encode()
	{
			...
			$crud->set_subject('Grades SY 2019-2020');
...
//COMMENT HERE TO SHOW READ ONLY AVERAGE
			...
			$crud->field_type('SY20192020ENGAVE','invisible');
			$crud->field_type('SY20192020FILAVE','invisible');
			$crud->field_type('SY20192020MATHAVE','invisible');
			$crud->field_type('SY20192020SCIAVE','invisible');
			$crud->field_type('SY20192020APAVE','invisible');
			$crud->field_type('SY20192020ESPAVE','invisible');
			$crud->field_type('SY20192020EPPAVE','invisible');
			$crud->field_type('SY20192020MUAVE','invisible');
			$crud->field_type('SY20192020MAPEHAVE','invisible');
			$crud->field_type('SY20192020ARAVE','invisible');
			$crud->field_type('SY20192020PEAVE','invisible');
			$crud->field_type('SY20192020HEAVE','invisible');
			$crud->field_type('SY20192020BACKAVE','invisible');
			$crud->field_type('SY20192020BACKAAVE','invisible');
			$crud->field_type('SY20192020BACKAAAVE','invisible');			
			$crud->field_type('SY20192020ENGAVE','invisible');
			$crud->field_type('SY20192020FILAVE','invisible');
			$crud->field_type('SY20192020MATHAVE','invisible');
			$crud->field_type('SY20192020SCIAVE','invisible');
	...
	function general_average7s1($post_array) {
		...
		$post_array['SY20192020MAPEH1']= round(($post_array['SY20192020MU1'] + $post_array['SY20192020AR1'] + $post_array['SY20192020PE1'] + $post_array['SY20192020HE1']) / 4);
$post_array['SY20192020MAPEH2'] = round(($post_array['SY20192020MU2'] + $post_array['SY20192020AR2'] + $post_array['SY20192020PE2'] + $post_array['SY20192020HE2']) / 4);
$post_array['SY20192020MAPEH3'] = round(($post_array['SY20192020MU3'] + $post_array['SY20192020AR3'] + $post_array['SY20192020PE3'] + $post_array['SY20192020HE3']) / 4);
$post_array['SY20192020MAPEH4'] = round(($post_array['SY20192020MU4'] + $post_array['SY20192020AR4'] + $post_array['SY20192020PE4'] + $post_array['SY20192020HE4']) / 4);
$post_array['SY20192020MAPEHAVE'] = round(($post_array['SY20192020MAPEH1'] + $post_array['SY20192020MAPEH2'] + $post_array['SY20192020MAPEH3'] + $post_array['SY20192020MAPEH4']) / 4);
$post_array['SY20192020FILAVE'] = round(($post_array['SY20192020FIL1'] + $post_array['SY20192020FIL2'] + $post_array['SY20192020FIL3'] + $post_array['SY20192020FIL4']) / 4);
$post_array['SY20192020ENGAVE'] = round(($post_array['SY20192020ENG1'] + $post_array['SY20192020ENG2'] + $post_array['SY20192020ENG3'] + $post_array['SY20192020ENG4']) / 4);
$post_array['SY20192020MATHAVE'] = round(($post_array['SY20192020MATH1'] + $post_array['SY20192020MATH2'] + $post_array['SY20192020MATH3'] + $post_array['SY20192020MATH4'])/ 4);
$post_array['SY20192020SCIAVE'] = round(($post_array['SY20192020SCI1'] + $post_array['SY20192020SCI2'] + $post_array['SY20192020SCI3'] + $post_array['SY20192020SCI4']) / 4);
$post_array['SY20192020APAVE'] = round(($post_array['SY20192020AP1'] + $post_array['SY20192020AP2'] + $post_array['SY20192020AP3'] + $post_array['SY20192020AP4']) / 4);
$post_array['SY20192020ESPAVE'] = round(($post_array['SY20192020ESP1'] + $post_array['SY20192020ESP2'] + $post_array['SY20192020ESP3'] + $post_array['SY20192020ESP4']) / 4);
$post_array['SY20192020EPPAVE'] = round(($post_array['SY20192020EPP1'] + $post_array['SY20192020EPP2'] + $post_array['SY20192020EPP3'] + $post_array['SY20192020EPP4']) / 4);
$post_array['SY20192020MUAVE'] = ($post_array['SY20192020MU1'] + $post_array['SY20192020MU2'] + $post_array['SY20192020MU3'] + $post_array['SY20192020MU4']) / 4;
$post_array['SY20192020ARAVE'] = ($post_array['SY20192020AR1'] + $post_array['SY20192020AR2'] + $post_array['SY20192020AR3'] + $post_array['SY20192020AR4']) / 4;
$post_array['SY20192020PEAVE'] = ($post_array['SY20192020PE1'] + $post_array['SY20192020PE2'] + $post_array['SY20192020PE3'] + $post_array['SY20192020PE4']) / 4;
$post_array['SY20192020HEAVE'] = ($post_array['SY20192020HE1'] + $post_array['SY20192020HE2'] + $post_array['SY20192020HE3'] + $post_array['SY20192020HE4']) / 4;

$post_array['SY20192020FinalAve'] = ($post_array['SY20192020FILAVE'] + $post_array['SY20192020ENGAVE'] + $post_array['SY20192020MATHAVE'] + $post_array['SY20192020SCIAVE'] + $post_array['SY20192020APAVE'] + $post_array['SY20192020ESPAVE'] + $post_array['SY20192020EPPAVE'] + $post_array['SY20192020MAPEHAVE']) / 8;
